...
const ReuseInput = ({ css }) => {
  ...
  const inputCSS = { backgroundcolor, color, width, height, fontsize, fontweigth, lineheight, letterspacing, borderradius, border, padding, margin, cursor, hoverbackgroundcolor, focusborder, focusbackgroundcolor };
